...
<?php
$test = get_option( 'woocommerce_enable_myaccount_registration' );
if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) :
	...
	<div class="u-columns col2-set" id="customer_login">
		...
		<?php
		$test2 = get_option( 'woocommerce_enable_myaccount_registration' );
		...
		<div class="u-column2 col-2">
			...
			<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
				...
				<?php if ( 'JM:nonono' != get_option( 'woocommerce_registration_generate_username' ) ) : ?>
				...
				<?php if ( 'JM:nonono' != get_option( 'woocommerce_registration_generate_password' ) ) : ?>
